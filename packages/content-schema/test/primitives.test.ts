...
// The bundled copy of a published release (generated by `npm run content:fallback`).
const release = JSON.parse(
  readFileSync(new URL("../../../src/data/release.fallback.json", import.meta.url), "utf8"),
) as { content: { collections: { pathTravelMessages: Array<{ fontColor: string }> } } };
...
describe("cssColorSchema", () => {
  it("accepts every color format used by current content", () => {
    const messages = release.content.collections.pathTravelMessages;
